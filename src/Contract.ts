...
export class Contract {
   ...
   */
  constructor(private rpc: GkcRPC, public info: IContractInfo, opts: IContractInitOptions = {}) {
   ...
   * @param req
   */
  public async logs(req: IRPCSearchLogsRequest = {}): Promise<IContractEventLogs> {
   ...
   */
  public async waitLogs(req: IRPCSearchLogsRequest = {}): Promise<IContractEventLogs> {
    ...
    const result = await this.rpc.searchlogs({
      ...req,
      addresses,
    })
   ...
   */
  public onLog(fn: (entry: IContractEventLog) => void, opts: IRPCSearchLogsRequest = {}) {
   ...
   */
  public logEmitter(opts: IRPCSearchLogsRequest = {}): EventEmitter {
